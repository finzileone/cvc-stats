...
const stagioni = {
  "2026-estate": {
    ...
    giornate: [
      ...
      { MaF: 2.25, MiF: 2.75, FP: 2, LB: 2, BC: 2.25, CM: 2.75, LuF: 2.75, ZG: 1, MP: 1, MaB: 0.25, AoB: 0.25, ML: 0.75, GF: 0.75, FG: 0.25, PF: 2.75 }
    ],
    match: [
      {
        teamA: ["MeF", "LeF"],
  ...
  "2025-invernale": {
    ...
    giornate: [
      ...
      { LF: 0.5, MaF: 2.25, MiF: 2.5, PS: 0.8, LB: 2.25, BC: 0.5, LuF: 2.5, ZG: 0.75, LeF: 1.35, MM: 2.65, AB: 0.75},
      { MaF: 0.75, MiF: 0.5, PS: 2.5, LB: 0.5, BC: 0.25, LuF: 2.5, ZG: 2.25, MP: 2.25, LeF: 2.75, PiS: 2.75, MM: 0.25, AoB: 0.75},
...
const datiGiocatori = {
  ...
  "LB": { tennista: "Luca Belitrandi", trofei: 15, oro: 9, argento: 3, bronzo: 3 },
  ...
  "LuF": { tennista: "Luca Fornari", trofei: 7, oro: 4, argento: 3, bronzo: 0 },
  ...
  "AoB": { tennista: "Antonio Bergamasco", trofei: 1, oro: 0, argento: 0, bronzo: 1 },
